...
router.post('/', requestValidation.validateLogWorkout, workoutController.logWorkout);

// GET route to get all workouts from the database 
router.get('/', workoutController.getAllWorkouts);

// DELETE route to remove a workout from the database by its id. 
router.delete('/:id', requestValidation.validateDeleteWorkout, workoutController.deleteWorkout);
